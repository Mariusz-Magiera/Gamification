          ...
          <div v-if="showModal">
            ...
            <div>
              ...
              <input
                ...
                name="description"
                value="Mickey"
                v-model="new_achievement_description"
              />
              <br />
              Points:<br />
              <input
                ...
                name="points"
                value="Mouse"
                v-model="new_achievement_points"
              />
              <br /><br />
...
export default {
  ...
  methods: {
    addAchievement() {
      ...
      Vue.axios
        .post(
          `users/id/${this.articles.id}/addAchievement?points=${
            this.new_achievement_points
          }&desc=${this.new_achievement_description}`,
          params
        )
        .then(response => {
